...
:deep(.watchlist-query-card.query-card) {
  background: transparent;
  width: 100%;
}

:deep(.watchlist-query-card .el-card__header) {
  padding: 4px 12px;
  background: transparent;
  border-bottom: none;
...
:deep(.watchlist-query-card .card-header) {
  font-size: 8px;
  font-weight: 600;
  letter-spacing: 1px;
...
:deep(.watchlist-query-card .el-card__body) {
  background: transparent;
  width: 100%;
  padding: 8px 12px 12px;
}

:deep(.watchlist-query-card .query-form) {
  display: block;
  width: 100%;
}
